...
【路由规则】
先依据 handoff_snapshot、recent_scene_excerpt 与 player_input，
确认当前地点、实际在场者、玩家正在回应的对象，以及尚未完成的互动。

区分“材料里有这个角色”“谈到了这个角色”和“这个角色实际在场”。
选择角色资料不代表安排该角色登场。

玩家继续与某个人交谈、追问、表达态度或处理两人之间的事情时，
优先延续当前互动；不得仅因候选锚点涉及其他人物就转移焦点。

玩家已要求单独交谈时，除非玩家改变安排，或已有明确事件改变现场，
不得为了推进剧情引入第三人。

只判断已有事实与材料的相关性，不设计新冲突、新期限或人物反应。
以上检查不单独输出，沿用现有 JSON。
1. `continue_deepen`
...
- `character_names`：0–6 名；只选择正在场、正在被谈论，或会由本轮锚点自然带入的人物，表示本轮需要读取资料的人物，不代表这些人物都在场或必须参与交流，优先选择玩家当前明确交谈的对象。其他人物只有在其资料确实影响本轮回应时才选择。新 NPC 必须在这里。玩家要独处时 character_names 输空。
